<template>
  ...
  <!-- Col -->
  <div
    class="mx-auto w-full sm:w-1/2 bg-white rounded-lg lg:rounded-l-none pb-10 pt-12"
  >
    ...
    >
      <div class="mb-4">
        ...
        <Field
          ...
          :class="{
            ...
            'focus:shadow-none': errors.email,
          }"
          name="email"
          type="text"
      ...
      <div class="mb-4">
        ...
        <Field
          ...
          :class="{
            ...
            'focus:shadow-none': errors.password,
          }"
          name="password"
          type="password"
          placeholder="******************"
        ...
        <p class="text-xs italic text-red-500">{{ passworderrors }}</p>
      </div>

      <div class="mb-6 text-center">
        <button
          class="flex justify-center mx-auto px-4 py-2 font-bold text-white bg-green-600 rounded hover:bg-green-400 focus:outline-none "
          type="submit"
        >
          <h3>Sign In</h3>
      ...
      <div class="text-center">
        <router-link
          to="/register"
          class="inline-block text-sm text-green-600 align-baseline hover:text-green-400"
        >
          Create an Account!
        </router-link>
      </div>
    ...
    onSubmit() {
      ...
      if (user) {
        ...
        if (expiry > today) {
          ...
          axios
            .post(BACKENDURL + "accounts/login/", this.user)
            .then((res) => {
              // console.log(res)
              // console.log("niko kwa response")
